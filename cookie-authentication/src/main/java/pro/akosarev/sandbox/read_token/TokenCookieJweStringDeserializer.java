 ...
 *
 * Зашифрованная строка выглядит так "1fdd4da3-894f-4a20-8bb5-4a2b52a91c07"
 *
 * Скопировано RefreshTokenJweStringDeserializer
 *
 ...
 *
 * Теперь можно аутентифицироваться по куке. Осталось реализовать Configurer
 */
public class TokenCookieJweStringDeserializer implements Function<String, Token> {
    ...
    public Token apply(String string) {
        try {
            ...
            // Constructs token from claims, including authorities and timestamps
